...
// include::index[snippets='response-body,http-response,links']
...
include::{snippets}/query-events/httpie-request.adoc[]
...
include::{snippets}/create-event/httpie-request.adoc[]
...
include::{snippets}/get-event/curl-request.adoc[]
include::{snippets}/get-event/http-request.adoc[]
include::{snippets}/get-event/httpie-request.adoc[]
...
include::{snippets}/update-event/httpie-request.adoc[]
...
include::{snippets}/update-event/links.adoc[]