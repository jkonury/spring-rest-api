...
public class EventControllerTest extends BaseControllerTest {
        ...
        .andDo(
            document(
                ...
                responseFields(
                    ...
                    fieldWithPath("_links.query-events.href")
                        .description("link to query event list"),
  ...
  public void getEvent404() throws Exception {
    mockMvc
        .perform(get("/api/events/{id}", Long.MAX_VALUE))
        .andDo(print())
  ...
  public void updateEvent() throws Exception {
    ...
    final String bearerToken =
        "Bearer " + getAccessToken(appProperties.getAdminEmail(), appProperties.getAdminPassword());
    mockMvc
        .perform(
            get("/api/events/{id}", event.getId()).header(HttpHeaders.AUTHORIZATION, bearerToken))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(jsonPath("name").exists())
        .andExpect(jsonPath("id").exists())
  ...
  public void updateEventError() throws Exception {
    ...
    mockMvc
        .perform(
            put("/api/events/{id}", Long.MAX_VALUE)
                .header(HttpHeaders.AUTHORIZATION, bearerToken)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaTypes.HAL_JSON)
                .content(objectMapper.writeValueAsString(eventDto)))
